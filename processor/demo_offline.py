...
class DemoOffline(IO):
    ...
    def predict(self, data):
        # forward
        #print ("data size in prediction : ", data.size()) # (1, C, T, V, M) # (1, 3, 300, 18, 3)
        # convert 5d to 4d
        N, C, T, V, M = data.size()
        ...
        feature = feature.permute(1,2,3,0)
        ...
        num_person = output.size(3) #data.size(4)
    ...
    def pose_estimation(self):
        ...
        #print('openpose arg : ', self.arg.openpose)
