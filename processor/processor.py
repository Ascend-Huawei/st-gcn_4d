...
class Processor(IO):
    ...
    def load_data(self):
        ...
        if self.arg.phase == 'train':
            ...
            # train_subset_1 = torch.utils.data.Subset(dataset, indices = range(10000))

            # self.data_loader['train_subset_1'] = torch.utils.data.DataLoader(
            #     train_subset_1,
            #     batch_size=self.arg.batch_size,
            #     shuffle=True,
            #     num_workers=self.arg.num_worker * torchlight.ngpu(
            ...
            # train_subset_2 = torch.utils.data.Subset(dataset, indices = range(10000, 20000))

            # self.data_loader['train_subset_2'] = torch.utils.data.DataLoader(
            #     train_subset_2,
            #     batch_size=self.arg.batch_size,
            #     shuffle=True,
            #     num_workers=self.arg.num_worker * torchlight.ngpu(
            ...
            # print ("train dataset : ", len(self.data_loader['train'].dataset))
            # print ("subset len : ", len(self.data_loader['subset'].dataset))
        ...
        if self.arg.test_feeder_args:
            ...
            # test_subset = torch.utils.data.Subset(test_dataset, indices = range(5001, 10000))

            # self.data_loader['test_subset'] = torch.utils.data.DataLoader(
            #     test_subset,
            #     batch_size=self.arg.batch_size,
            #     shuffle=True,
            #     num_workers=self.arg.num_worker * torchlight.ngpu(
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--device', type=int, default=4, nargs='+', help='the indexes of GPUs for training or testing')
